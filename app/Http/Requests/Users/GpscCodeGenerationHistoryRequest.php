...
use App\Models\GpcsCodeHistory;
use App\Enums\StatusCode;
use App\Traits\ModelValidatorTrait;
use Illuminate\Support\Facades\Storage;

class GpscCodeGenerationHistoryRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            'gpcs_codes_id' => 'nullable|integer|max:5000',
